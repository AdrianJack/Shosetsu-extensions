...
return Require("ReadWN")("https://www.wuxiabee.org", {
	...
	listingsMap = {
		...
		},
		{
			...
			increments = true,
			url = function(data)
				return "https://www.wuxiabee.org/list/all/all-lastdotime-" .. (data[PAGE] - 1) .. ".html"
			end
		},
		{
			name = "Most Popular",
			increments = true,
			url = function(data)
				return "https://www.wuxiabee.org/list/all/all-onclick-" .. (data[PAGE] - 1) .. ".html"
			end
		},
		{
			...
			increments = true,
			url = function(data)
				return "https://www.wuxiabee.org/list/all/all-newstime-" .. (data[PAGE] - 1) .. ".html"
			end
		}
	},
})